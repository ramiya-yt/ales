...
module.exports = {
    ...
    XURL: process.env.XURL === undefined ?'https://api.zeks.me/api/' : process.env.XURL,
    XTPS: process.env.XTPS === undefined ?'textpro-scraper?apikey=' : process.env.XTPS,
    XEPS: process.env.XEPS === undefined ?'ephoto-scraper?apikey=' : process.env.XEPS,
    XAPI: process.env.XAPI === undefined ?'ramiyaplugins' : process.env.XAPI,
    BRANCH: 'master',
    HNLOCK: 'hadi-api',
    ZLOCK: 'zeks',
    ZNLOCK: 'zenzapi.xyz',
